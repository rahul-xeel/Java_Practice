...
public class Code {
    ...
    public static void main(String agrs[]) {
        ...
        System.out.println();
        System.out.println();
        System.out.println("Finding FLoor Of The Number In Agnostic Array");
        System.out.println();
        System.out.println();
        ...
        if (nums[0] < nums[nums.length - 1]) {
            ...
            int ans = Increasing_order_Last_position(nums, target);
            if(ans == -1)
            {
            ...
            System.out.print("Floor of "+target+ " is " + nums[ans]);
                ...
                int ans = Decreasing_order_First_position(nums, target);
                if(ans == -1)
                {
                    System.out.println("Element not found");
                }
