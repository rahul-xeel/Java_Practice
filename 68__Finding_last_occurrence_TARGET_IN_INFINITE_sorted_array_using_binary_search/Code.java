...
class Code {
    public static void main(String args[]) {
        ...
        System.out.println();
        System.out.println(
                " -------------    FINDING INDEX OF LAST OCCURRENCE IN INFINITE SORTED ARRAY USING ONE BINARY SEARCH   ---------------");
        System.out.println();
        System.out.println();
              ...
              while(start <= end)
                {
                    ...
                    if(arr[mid] == target)
                    {
                        target_index = mid;   // store index
                        start = mid + 1;      // move right for last occurrence
                    }
                    else if(arr[mid] < target)   // because array is decreasing
                    {
                        end = mid - 1;
                    }
                    else
